...
ActiveRecord::Schema.define(version: 20150212024351) do
  ...
  add_index "bookcases_books", ["bookcase_id", "book_id"], name: "index_bookcases_books_on_bookcase_id_and_book_id", using: :btree
